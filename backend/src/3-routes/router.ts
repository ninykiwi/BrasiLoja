...
import { get_product_by_name, get_product_by_category, make_product, delete_product,edit_product, get_product_by_id } from "../2-controllers/controllers"
...
router.get('/get_product_by_id', get_product_by_id)
